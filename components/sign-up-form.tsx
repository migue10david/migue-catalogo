    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <Card className="shadow-lg border-0 ring-1 ring-black/5 dark:ring-white/10">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold tracking-tight">Regístrate</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSignUp}>
            <div className="flex flex-col gap-5">
              ...
              <div className="grid gap-2">
                <Label htmlFor="repeat-password" className="text-sm font-medium">Repite la contraseña</Label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 size-4 -translate-y-1/2 text-muted-foreground/60" />
                  <Input
                    id="repeat-password"
